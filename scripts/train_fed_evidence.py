"""
ThuanPhongNhi Federated Training Script
=========================================
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="ThuanPhongNhi: EAFA federated training")
    ...
    logger.info(f"\n{'='*60}")
    logger.info(f"  ThuanPhongNhi: {mode} (beta={args.beta})")
