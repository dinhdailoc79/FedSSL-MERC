...
info_table.rows[0].cells[1].text = "Fed-Evidence: Uncertainty-Aware Federated Semi-Supervised Learning for Multimodal Emotion Recognition in Conversations"
...
all_tasks = [
    ...
    ("Review proposal Fed-Evidence, gap analysis vs implementation",
     "Completed", "2h",
